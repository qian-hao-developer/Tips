...
BRANCH=ps152-cobra-release;
LOCAL_BRANCH=local-ps152-bsp-update;
CUSTOM=C04;
SI=015
REGION=90
RELEASE="release"
...
initCobra(){
    ...
    date >> time.txt
    repo forall -c git checkout -B local-ps152-bsp-update2 rhea/local-ps152-bsp-update2
